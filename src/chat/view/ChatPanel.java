...
public class ChatPanel extends JPanel
{
	...
	private void setupLayout()
	{
		...
		appLayout.putConstraint(SpringLayout.SOUTH, chatButton, -86, SpringLayout.SOUTH, this);
		appLayout.putConstraint(SpringLayout.NORTH, chatButton, 31, SpringLayout.SOUTH, chatField);
		...
		appLayout.putConstraint(SpringLayout.WEST, saveButton, -334, SpringLayout.EAST, this);
		appLayout.putConstraint(SpringLayout.SOUTH, saveButton, -86, SpringLayout.SOUTH, this);
		appLayout.putConstraint(SpringLayout.EAST, saveButton, -259, SpringLayout.EAST, this);
		appLayout.putConstraint(SpringLayout.NORTH, saveButton, 31, SpringLayout.SOUTH, chatField);
		...
		appLayout.putConstraint(SpringLayout.WEST, loadButton, 108, SpringLayout.EAST, checkerButton);
		
		appLayout.putConstraint(SpringLayout.NORTH, checkerButton, 31, SpringLayout.SOUTH, chatField);
		appLayout.putConstraint(SpringLayout.SOUTH, checkerButton, -86, SpringLayout.SOUTH, this);
		checkerButton.setHorizontalAlignment(SwingConstants.LEADING);
